...
df_emergency_contacts = pd.read_excel("datasets/employee_information.xls",sheet_name=1)
print(df_emergency_contacts.head())

# Declare a list of new column names
emergency_contacts_header = "employee_id, last_name, first_name, emergency_contact, emergency_contact_number, relationship".split(",")

# Rename the columns
df_emergency_contacts.columns =emergency_contacts_header

print("correct df_emergency_contacts:\n",df_emergency_contacts.head())
...
print("d:",df_employee_roles.head())
...
#print(df_employee_roles.index)
#print(df_employee_roles.head(15))
#print(df_employee_roles.shape)
...
#print("After:",df_employees.head(15))
# Merge df_office_adresses with df_employees
#print(df_employees.index)
#print("111:",df_employees.columns)
#print("222:",df_office_addresses.columns)
...
#new_header = "id, country, city, street, street_number, last_name, first_name, emergency_contact, emergency_number, emergency_relationship, monthly_salary, team, title, office, office_country, office_city, office_street, office_street_number".split(", ")
...
#print(df_employees_final.head(2))
status_list = []
import numpy as np
...
#distinct
print(df_employees_final['status'].unique())
# Take a look at the first rows of the DataFrame
...
# Write to CSV
df_employees_final.to_csv("Employees_final_data.csv")
